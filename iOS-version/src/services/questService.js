...
// V1: labels softened away from category vocabulary.
const QUEST_POOL = [
  { id: 'read_forecast', label: 'Read your daily briefing', icon: '☉', checkKey: 'forecast_read' },
  { id: 'journal', label: 'Write in your journal', icon: '✍', checkKey: 'journal_written' },
  { id: 'deep_dive', label: 'Explore one part of your chart', icon: '🌊', checkKey: 'deep_dive_done' },
  { id: 'chat', label: 'Ask a question', icon: '☽', checkKey: 'chat_sent' },
  { id: 'share', label: 'Share an insight', icon: '↗', checkKey: 'shared' },
  { id: 'check_transits', label: 'Check today\'s outlook', icon: '✧', checkKey: 'transits_checked' },
