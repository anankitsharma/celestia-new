...
export const initSchema = async () => {
    ...
    try {
        ...
        // V1.2 — journal becomes an interactive reflection tool (PDF plan §04 Today tab).
        // ai_response: 2-3 sentence gentle reflection from Gemini after user writes.
        // partner_id: optional tag so Drift Alert can pull "last time you wrote about X".
        await addColumnIfMissing(db, 'journal_entries', 'ai_response', 'TEXT');
