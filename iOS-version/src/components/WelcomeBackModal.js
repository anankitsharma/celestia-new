        ...
        <View style={s.card}>
          <LinearGradient colors={['#5A2840', '#3A1A28']} style={s.hero}>
            ...
            <Text style={s.heroTitle}>
              {hasComeback ? 'Welcome Back' : 'Good to See You'}
            </Text>
            <Text style={s.heroSub}>
              {daysAbsent > 1
                ? `${daysAbsent} days of briefings are waiting for you.`
          ...
          <View style={s.body}>
              ...
              <View style={{ flex: 1 }}>
                {streakBroken ? (
                  ...
                  <>
                    ...
                    <Text style={s.streakSub}>Your streak shield kept it alive.</Text>
                  </>
                )}
              </View>
            </View>
            ...
            {hasComeback && (
              <View style={s.bonusRow}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={s.bonusLabel}>2x XP Today</Text>
            ...
            {streakData.streak_freezes_remaining > 0 && (
              <View style={s.freezeRow}>
                ...
                <Text style={s.freezeText}>
                  {streakData.streak_freezes_remaining} streak shield{streakData.streak_freezes_remaining > 1 ? 's' : ''} available
                </Text>
              </View>
            )}

            {/* V1: Moon-phase line removed — astrology surface in welcome-back modal. */}

            {/* Today's briefing CTA */}
            <Text style={s.readyText}>Your fresh briefing is ready.</Text>
            ...
            <TouchableOpacity style={s.btn} activeOpacity={0.85} onPress={onDismiss}>
              <LinearGradient
                ...
                style={s.btnGrad}>
                <Text style={s.btnText}>See Today's Briefing</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
        </View>
