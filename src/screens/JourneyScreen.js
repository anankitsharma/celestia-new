        ...
        <View style={s.body}>
          ...
          {badges.length > 0 && (
            <View style={s.section}>
              <Text style={[s.sectionLabel, subStyle]}>COSMIC CHAPTERS ({badges.filter(b => b.unlocked).length}/{badges.length})</Text>
          ...
          {userProfile?.chart && (() => {
            ...
            return (
              <View style={s.section}>
                <Text style={[s.sectionLabel, subStyle]}>YOUR COSMIC RARITY</Text>
...
const s = StyleSheet.create({
  ...
  heroSub: { fontSize: 12, color: 'rgba(250,248,242,0.45)', marginBottom: 18 },
  statsRow: { flexDirection: 'row', gap: 10 },
  statPill: { flex: 1, backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 12, alignItems: 'center', gap: 4 },
  statNum: { fontFamily: FONTS.serif, fontSize: 20, color: '#FAF8F2' },
  statLbl: { fontSize: 9, color: 'rgba(250,248,242,0.45)', letterSpacing: 0.5 },
