...
const BENEFITS = [
  { glyph: '☉', title: 'Morning cosmic reading', sub: 'Personalized to your transits' },
      ...
      <View style={s.overlay}>
        <View style={s.card}>
          <LinearGradient colors={['#3A1A28', '#1A1060', '#0C2040']} style={s.gradient}>
            ...
            <Text style={s.sub}>
              The stars move fast. Get a personalized cosmic briefing every morning — written from your actual chart.
            </Text>
            ...
            <TouchableOpacity activeOpacity={0.85} onPress={onEnable}>
              <LinearGradient colors={['#C8A84B', '#A08030']} style={s.cta}>
                <Text style={s.ctaText}>Enable Cosmic Alerts</Text>
              </LinearGradient>
            </TouchableOpacity>
