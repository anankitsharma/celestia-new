...
import { SIGN_ELEMENTS, SIGN_MODALITIES, PlanetName, ZodiacSign } from './constants';
...
import { calculateSynastryScore as _calcSynastry, calculateZodiacOnlyScore, ROLE_COLORS } from './astrology/SynastryService';

export { calculateZodiacOnlyScore, ROLE_COLORS };

export const calculateSynastry = (chart1, chart2) => {
    try {
        return _calcSynastry(chart1, chart2);
    } catch (e) {
